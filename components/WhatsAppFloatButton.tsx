...
export default function WhatsAppFloatButton() {
  return (
    ...
    >
      ...
      <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-10 animate-ping [animation-duration:2.5s] [animation-delay:1.2s]" />
      ...
      <a
        ...
        data-cursor="hover"
        className="relative flex h-16 w-16 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-black/30 transition-transform duration-300 ease-luxe hover:scale-110 hover:shadow-xl"
      >
        <svg
          viewBox="0 0 24 24"
          className="h-9 w-9"
